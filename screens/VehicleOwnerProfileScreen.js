    ...
    <SafeAreaView style={{ flex: 1, backgroundColor: '#f7f7f7' }}>
      <ScrollView contentContainerStyle={styles.container}>
        ...
        <Section title="ACCOUNT">
          <MenuItem icon="person-outline" label="Edit Profile" onPress={() => navigation.navigate('VehicleOwnerEditProfile')} />
          <MenuItem icon="car-outline" label="My Vehicles" onPress={() => navigation.navigate('VehicleManagement')} />
          <MenuItem icon="clipboard-outline" label="My Trips" onPress={() => navigation.navigate('TripManagement')} />
        ...
        <Section title="SETTINGS">
          ...
          <MenuItem icon="card-outline" label="Bank & Payment Info" onPress={() => Alert.alert('Coming soon')} />
